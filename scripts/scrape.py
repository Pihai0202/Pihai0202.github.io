...
def get_cpbl_player_name(acnt):
    ...
    padded = acnt_str.zfill(10)
    if padded in CPBL_PLAYER_CACHE:
        return CPBL_PLAYER_CACHE[padded]
    stripped = acnt_str.lstrip("0")
    if stripped in CPBL_PLAYER_CACHE:
        return CPBL_PLAYER_CACHE[stripped]
    try:
